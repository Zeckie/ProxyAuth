...
/**
 * Check that Kotlin hasn't "accidentally" been added
 */
public class ImposterCheck {
    @Test
    void checkForImposter() {
        Assertions.assertThrows(ClassNotFoundException.class, () -> Class.forName("kotlin.Unit"));
    }
}
